...
<input placeholder="Enter the phonenumber" name="contactno" type="text" class="form-control mb-2" >
<button type="submit" class="btn btn-success">Submit</button><a href="/stafflogin" class="mx-2 btn btn-success" >Login</a>
</form>
</div>
<div class="col-sm-4"></div>
</div>
